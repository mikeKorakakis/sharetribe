        ...
        "guide": {
          ...
          "cover_photo": {
            ...
            "advice": {
              ...
              "alt_images": "6 photos de couverture prêtes à l'emploi et comment en trouver encore plus",
              "content1": "Téléchargez %{link_images} ou jetez un oeil à %{link} pour trouver de superbes images libres de droits.",
              ...
              "link": "notre guide",
              "link_images": "une des images déjà optimisées"
            },
          ...
          "payments": {
            "advice": {
              ...
              "content_paypal_stripe": "En savoir plus sur comment désactiver les paiement dans %{disable_payments_link} ou lire plus de détails sur %{stripe_paypal_link}.",
              "disable_payments_alt": "Comment désactiver les paiements dans votre place de marché",
              "disable_payments_link": "cet article",
              "stripe_paypal_link": "le système de paiement en ligne, Stripe et PayPal"
            },
            "cta_separator": "ou",
            "description_p1": "Si vous voulez permettre à vos utilisateurs de recevoir des paiements, vous devez connecter une plateforme de paiement (vous recevrez une commission sur chaque transaction). Sharetribe supporte à la fois Stripe et PayPal. Une fois connecté, vous devrez définir vos frais de service (commission).",
