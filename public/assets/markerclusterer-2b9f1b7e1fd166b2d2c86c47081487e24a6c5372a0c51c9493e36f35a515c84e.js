...
MarkerClusterer.prototype.MARKER_CLUSTER_IMAGE_PATH_ =
  "/assets/map_icons/m1-5118720be739d6eaaa6c5e9dfce3c6ba3f15838ba5aa5dfec6687bc24bc4413e.png".replace(/\.png$/, '');
...
ClusterIcon.prototype.triggerClusterClick = function() {
  ...
  // SHARETRIBE modification START
  var isInMaxZoom = function(map) {
    return map.getZoom() >= map.maxZoom;
  }

  var allEquals = function(arr, comparator) {
    var first = arr[0];
    return arr.every(function(a) { return comparator(first, a) });
  }

  var sameLocation = function(markers) {
    var positions = markers.map(function(marker) {
      return marker.getPosition();
    });

    return allEquals(positions, function(a, b) {
      return a.equals(b);
    });
  }
  // SHARETRIBE modification END
  ...
  var shouldShowInfoBubble = sameLocation(markers) || isInMaxZoom(this.map_);

  if (shouldShowInfoBubble) {
