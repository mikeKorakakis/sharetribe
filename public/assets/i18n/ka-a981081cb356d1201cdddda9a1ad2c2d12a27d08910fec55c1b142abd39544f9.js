...
(typeof(window) === 'undefined' ? global : window).I18n.translations["ka"] = {
  "web": {
    ...
    "branding": {
      "create_own": "გსურთ რომ შექმნათ თქვენი პირადი ბაზრის ონლაინ ვებ გვერდი როგორიცაა %{service_name}? %{learn_more}.",
      "learn_more": "გაიგეთ მეტი",
      "powered_by": "%{service_name} ფუნქციონირებს %{sharetribe_link}-ის ბაზრის პლატფორმაზე."
    },
    "listing_card": {
      "add_picture": "დაამატე სურათი",
      "no_picture": "სურათი არ არის"
    },
    "listings": {
      "confirm_discarding_unsaved_availability_changes_explanation": "თქვენ არ დაგისრულებიათ ცვლილებების შეტანა. თუ გააგრძელებთ, ეს ცვლილებები დაიკარგება.",
      "confirm_discarding_unsaved_availability_changes_question": "დარწმუნებული ხართ რომ გსურთ უარყოთ ცვლილებები?",
      "edit_availability_header": "ხელმისაწვდომობა",
      "edit_listing_availability": "დაარედაქტირე ჩამონათვალის ხელმისაწვდომობა",
      "errors": {
        "availability": {
          "saving_failed": "ცვლილებების შენახვა ვერ მოხერხდა. გთხოვთ სცადოთ გვერდის გადატვირთვა.",
          "something_went_wrong": "ჩვენ ვერ შევძელით გვეჩვენებინა ხელმისაწვდომობის ინფორმაცია. გთხოვთ სცადოთ გვერდის გადატვირთვა."
        },
        "working_hours": {
          "covers": "covers",
          "overlaps": "overlaps",
      ...
      "save_and_close_availability_editing": "შეინახეთ და დახურეთ",
      "working_hours": {
    ...
    "no_listings": {
      "sorry": "სამწუხაროდ თქვენი ძებნის კატეგორიით ვერ მოიძებნა ჩამონათვალი. იქნებ სხვა ძებნის პირობები ცადოთ?",
      "try_other_search_terms": "იქნებ სცადოთ სხვა ძებნის პირობები."
    },
    "search": {
      "page": "გვერდი",
      "page_of_pages": "%{total_number_of_pages}ის"
    },
    "topbar": {
